...
(function (Advocate) {
    ...
    })(Administration = Advocate.Administration || (Advocate.Administration = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Administration;
...
(function (Advocate) {
    ...
    })(Authorization = Advocate.Authorization || (Advocate.Authorization = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Administration;
...
(function (Advocate) {
    ...
    })(BasicSamples = Advocate.BasicSamples || (Advocate.BasicSamples = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Northwind;
    (function (Northwind) {
        var ProductDialog = (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () {
                return Advocate.LanguageList.getValue();
            };
    ...
    })(Northwind = Advocate.Northwind || (Advocate.Northwind = {}));
})(Advocate || (Advocate = {}));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Advocate.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Advocate.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Advocate.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Advocate.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Advocate.Northwind.OrderDialog();
                        ...
                        var chai = Advocate.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Advocate.Northwind.EmployeeRow.getLookup().items
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    Advocate.Northwind.CategoryService.Retrieve({
        ...
        }(Advocate.Northwind.CategoryDialog));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.CategoryGrid));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Advocate.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.OrderDialog));
        ...
        var OtherFormInTabDialog = (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                this.customerPropertyGrid = new Serenity.PropertyGrid(this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(Advocate.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                this.customerForm = new Advocate.Northwind.CustomerForm(this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Advocate.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Advocate.Northwind.CustomerRow.lookupKey);
                ...
                this.form.CustomerID.change(function (e) {
                    ...
                    Advocate.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Advocate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Advocate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Advocate.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Advocate.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Advocate.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Advocate.Northwind.OrderService.baseUrl; };
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.SupplierDialog));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Advocate.Northwind.SupplierGrid));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Advocate.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Advocate.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Advocate.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Advocate.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Advocate.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Advocate.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Advocate.Northwind.CustomerDialog));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.CustomerGrid));
...
(function (Advocate) {
    ...
    })(Common = Advocate.Common || (Advocate.Common = {}));
})(Advocate || (Advocate = {}));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Advocate.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Advocate.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Advocate.Northwind.ProductRow.lookupKey;
            };
...
(function (Advocate) {
    ...
    (function (Northwind) {
        ...
        }(Advocate.Common.GridEditorBase));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Northwind.OrderDetailsEditor));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Advocate.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Advocate.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Advocate.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new Advocate.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = Advocate.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(Advocate.Northwind.OrderDetailDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Advocate.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Advocate) {
    ...
    Advocate.StaticTextBlock = StaticTextBlock;
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var BasicSamples;
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Advocate.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Advocate.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Advocate.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Advocate.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Advocate.Northwind.OrderRow.Fields;
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Advocate.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Advocate.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Advocate.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Advocate.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Advocate.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Advocate) {
    ...
    Advocate.SelectableEntityGrid = SelectableEntityGrid;
})(Advocate || (Advocate = {}));
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Advocate.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Advocate.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Advocate.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Advocate.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Advocate.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Advocate.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Advocate.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Advocate.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Advocate.Northwind.ProductService.baseUrl; };
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Advocate.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Advocate.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Advocate.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Advocate) {
    ...
    Advocate.BasicProgressDialog = BasicProgressDialog;
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Advocate.BasicProgressDialog();
...
(function (Advocate) {
    ...
    })(DialogUtils = Advocate.DialogUtils || (Advocate.DialogUtils = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Common;
...
(function (Advocate) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Advocate.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Advocate.LanguageList || (Advocate.LanguageList = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Common;
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Advocate.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Advocate.BasicSamples || (Advocate.BasicSamples = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Advocate.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Advocate.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Advocate.BasicSamples || (Advocate.BasicSamples = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Advocate.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Advocate.StaticTextBlock; }], ['FromLocalText', function () { return Advocate.StaticTextBlock; }], ['DisplayFieldValue', function () { return Advocate.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Advocate.BasicSamples || (Advocate.BasicSamples = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
...
(function (Advocate) {
    ...
    })(Membership = Advocate.Membership || (Advocate.Membership = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Membership;
...
(function (Advocate) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Advocate.Northwind.Entities.Gender');
    })(Northwind = Advocate.Northwind || (Advocate.Northwind = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
...
(function (Advocate) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Advocate');
    })(ScriptInitialization = Advocate.ScriptInitialization || (Advocate.ScriptInitialization = {}));
})(Advocate || (Advocate = {}));
var Advocate;
(function (Advocate) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Advocate.Authorization.userDefinition.DisplayName,
...
(function (Advocate) {
    ...
    (function (BasicSamples) {
        ...
        }(Advocate.Common.BulkServiceAction));
...
//# sourceMappingURL=Advocate.Web.js.map